	...
	<div class="md-modal md-just-me" id="logout-modal">
		<div class="md-content">
			...
			<div>
				...
				<a href="<?php echo $host?>/site/login.php" class="btn btn-success md-close">Yeah, I'm sure</a>
				</p>
			</div>
		</div>
	</div>        <!-- Modal End -->	
            ...
            <div class="sidebar-inner slimscrollleft">
                ...
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <li><a class="<?php echo ($title == 'User') ? 'active' : null ?>" href='javascript:void(0);'><i class='icon-user'></i><span>Platforms</span> <span class="pull-right"><i class="fa fa-angle-down"></i></span></a>
                            <ul>
                                <li><a href='<?php echo $host?>/platform/add'><span>Add New</span></a></li>
                                <li><a href='<?php echo $host?>/platform'><span>View All</span></a></li>
                            </ul>
                        </li>

                        <li><a class="<?php echo ($title == 'User') ? 'active' : null ?>" href='javascript:void(0);'><i class='icon-user'></i><span>Users</span> <span class="pull-right"><i class="fa fa-angle-down"></i></span></a>
                            <ul>

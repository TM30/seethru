								  ...
								  <div class="form-group">
									<div class="row">
										<div class="col-sm-6">
											...
											<input id="password" type="password" class="form-control" required="yes" name="password" value="<?php echo (!isset($profile)) ? NULL : trim($profile->getPassword()) ?>">
										</div>
										<div class="col-sm-6">
											<label>Re-Password<span id="error"></span></label>
											<input id="cpassword" type="password" class="cpassword form-control" required="yes" name="cpassword" value="<?php echo (!isset($profile)) ? NULL : trim($profile->getPassword()) ?>">
										</div>
									</div>
								  </div>
